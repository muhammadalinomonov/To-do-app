...
@HiltViewModel
class AddTodoViewModelImpl @Inject constructor(private val repository: AppRepository) : ViewModel(),
    AddTaskViewModel {
    ...
    override fun addClicked() {
        ...
        _closedLiveData.value = Unit
    }

    override fun addTask(id: UUID) {
        ...
        repository.insertTask(
            TaskEntity(
                0, title, description, date, time, 0, priority, category.id, id
            )
        )
